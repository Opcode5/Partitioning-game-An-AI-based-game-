...
class MyGridLayout(GridLayout):
    ...
    def callback(self, instance):
        ...
        #self.add_widget(Label(text=f"{self.n},{self.n}"))
        my = self.my.text
        oppo = self.opponent.text
        if(self.d=="you"):
            # self.add_widget(Label(text=f"{self.n}"))
            dd = int(self.n)
            if(dd==1 or dd==2):
                quit()
            ...
            dd = int(self.n)
            #self.add_widget(Label(text=f"{10+dd}"))
            if (dd==1 or dd==2):
                quit()
            if(dd==1 or dd==2):
                exit()
            # self.add_widget(Label(text=f"{d+1},{d}"))
            a=aa[dd]
            b=bb[dd]
            # self.add_widget(Label(text=f"{a},{b}"))
